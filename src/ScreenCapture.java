...
public class ScreenCapture { 
    ...
    public static void go() {  
        File tempFile = new File("database" + File.separator + "temp.png");  
    ...
    private ScreenCapture() {  
        ...
        dialog.setSize(new Dimension((int)(Toolkit.getDefaultToolkit().getScreenSize().getWidth()), (int)(Toolkit.getDefaultToolkit().getScreenSize().getHeight()-37)));  
